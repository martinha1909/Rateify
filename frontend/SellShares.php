...
<?php
    ...
    echo "<script>alert('Share(s) sold sucessfully');</script>";
    if($_SESSION['notify'] == 2)
    echo "<script>alert('Failed to sell share');</script>";
    $_SESSION['notify'] = 0;
?>
        ...
        <div class="row vh-md-100">
            <div class="col-md-8 col-sm-10 col-12 mx-auto my-auto text-center">
              ...
              <div class="col text-center">
                <h2>How many shares would you like to sell?</h2>
              </div>
                ...
                <form action="../APIs/ShareSellConnection.php" method="post">
                    ...
                    <button style="background-color: white; border: white;" type = "submit">Sell!</button>
                    </div>
                  </div>
                    </div>
